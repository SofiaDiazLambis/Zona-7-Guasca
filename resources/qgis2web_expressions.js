...
function exp_CURVAS_1rule0_eval_expression(context) {
    // ttcn = 50

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('ttcn')  == 50);
    } else {
        return (feature.get('ttcn')  == 50);
    }
}
...
function exp_CURVAS_1rule1_eval_expression(context) {
    // ttcn = 10

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('ttcn')  == 10);
    } else {
        return (feature.get('ttcn')  == 10);
    }
}
...
function exp_VIAS_3rule0_eval_expression(context) {
    // "CLASIFICACION VIA" = 1

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('CLASIFICACION VIA')  == 1);
    } else {
        return (feature.get('CLASIFICACION VIA')  == 1);
    }
}
...
function exp_VIAS_3rule1_eval_expression(context) {
    // "CLASIFICACION VIA" = 2

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('CLASIFICACION VIA')  == 2);
    } else {
        return (feature.get('CLASIFICACION VIA')  == 2);
    }
}
...
function exp_VIAS_3rule2_eval_expression(context) {
    // "CLASIFICACION VIA" = 3

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('CLASIFICACION VIA')  == 3);
    } else {
        return (feature.get('CLASIFICACION VIA')  == 3);
    }
}